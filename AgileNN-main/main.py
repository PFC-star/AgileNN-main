...
parser.add_argument('--dataset', type=str, default='imagenet200',
                    help='valid datasets are cifar10, cifar100, svhn, imagenet200')
parser.add_argument('--split_ratio', type=float, default=0.2,
                    help='num_local_features / (num_local_features + num_remote_features)')
parser.add_argument('--rho', type=float, default=0.8, help='skewness of feature importance')
parser.add_argument('--klambda', type=float, default=0.8,
                    help='to balance loss terms, lambda * L_ce + (1 - lambda) (L_skewness + L_disorder)')
parser.add_argument('--num_centroids', type=int, default=8,
                    help='quantize remote features to log2(num_centroids) bit representation ')
parser.add_argument('--channel_remapping', type=str, default='topk_appearance', help='preprocess feature extractor, refer to Sec 5 in our paper, \
