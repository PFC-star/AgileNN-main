...
def train_effnetv2_on_imagenet200(run_name, logdir):
    ...
    train_dataset = tf.keras.preprocessing.image_dataset_from_directory(
         r'..\dataset\extracted\ZIP.cs231n.stanford.edu_tiny-imagenet-200YZjIrgFeKz4AfHhB2jnsBpGZuao7-pQ6RiAi_l5DyCE.zip\tiny-imagenet-200\train',
        labels='inferred',
        label_mode='int',
        color_mode='rgb',
        batch_size=8,
    ...
    test_dataset = tf.keras.preprocessing.image_dataset_from_directory(
        r'..\dataset\extracted\ZIP.cs231n.stanford.edu_tiny-imagenet-200YZjIrgFeKz4AfHhB2jnsBpGZuao7-pQ6RiAi_l5DyCE.zip\tiny-imagenet-200\val',
        labels='inferred',
        label_mode='int',
        color_mode='rgb',
        batch_size=32,
